...
<head>
	...
	<title>ccode Control Records</title>
	<!-- links -->
	...
	{	
        ...
        if(ctlCode.value == "" || !ctlCode.value.match(Code))
	    	{
		      alert("ERROR: The Code contains invalid input. Enter 2 Letters Only");
	          return false;
	        }
		...
		if (!ctlCountry.value.match(Letters) || ctlCountry.value == "")
		{
		...
		ctlColor = document.getElementById("color");
		
		if(!ctlColor.value.match(LettersNumber) && !ctlColor.value == "")
				{
			        alert("ERROR: Color contains invalid Input, Only input [0-9a-zA-Z]");
			        return false;	
	         	}
	...
	function sendDataToServer()
	{
		if (ValidateForm() == false)    //Validate Form Fields
		    ...
		    /**************************** Basic data ***************************************/
				...
				var e =  document.getElementById("worldclass");
				var varWorldclass = e.options[e.selectedIndex].value;
...
<body onload = loadCodeInterfaceDataFromServer()>
	...
	<section class="container clearfix">
		...
		<header class="container page_info clearfix">	
			<h1 class="regular brown bottom_line"> Add CCODES</h1>
			<div class="clear"></div>
		</header>
		<!-- END PAGE INFO -->
		...
		<div class="col_1_4">
			<ul class="contact-address">
				...
				<li class="edit"><span><a href="CcodesRecord.php">Search Record</a></span></li>
<!-- 				<li class="delete"><span><a href="deleteCcodesRecord.html">Delete Record</a></span></li> -->
		...
		<!-- START COL 1/3 -->	
		<div class="col_1_3">
			<h4 class="bottom_line regular"><b>Add New CCODES </b></h4>
			...
			<form action="#" class="contact_form">
				<p>
					...
					<input class="inputText" type="text" id="code" name="code" />
					<label for="name"> country <span>*</span></label>
					<input class="inputText" type="text" id="country" name="country" />
					...
					<input class="inputText" type="text" id="color" name="color" />
				</p>
			</form>
		</div>	
