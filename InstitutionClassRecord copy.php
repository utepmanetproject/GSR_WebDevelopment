				...
				<ul>
					...
					<li><a href="#">IP Address-Related</a>
						<ul>
							...
							<li><a href="ipsLabels.php">iplabels</a></li>							
	...
	<section class="container clearfix">
		...
		<div class="col_1_4">
			...
			<ul class="contact-address">
				...
				<li class="edit"><span><a href="ViewInstitutionClassRecord.html">Search Record</a></span></li>
			</ul>
			<p>
		...
		<div class="col_1_3">
			...
			<form action="#" class="contact_form">
				<p>
					...
					<input class="inputText" type="text" id="organization" name="organization" placeholder="Search for an Institution ..." />
					...
					<input class="inputText" type="text" id="ccode" name="ccode" />
