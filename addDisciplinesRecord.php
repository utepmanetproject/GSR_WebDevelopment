...
<!--   scripts -->
	...
	function ValidateForm()
	{
        ...
        if (!ctlDiscid.value.match(Numbers) || ctlDiscid.value == "")
	       {
		...
		if (!ctlDiscipline.value.match(Letters) || ctlDiscipline.value == "")
		{
...
<body>
	...
	<section class="container clearfix">
		...
		<header class="container page_info clearfix">	
			<h1 class="regular brown bottom_line">ADD New DISCIPLINE</h1>
			<div class="clear"></div>
		</header>
		<!-- END PAGE INFO -->
		...
		<div class="col_1_4">
			<ul class="contact-address">
				...
				<li class="edit"><span><a href="DisciplinesRecord.php">Search Record</a></span></li>
<!-- 				<li class="delete"><span><a href="EliminateDisciplinesRecord.html">Delete Record</a></span></li> -->
		...
		<!-- START COL 1/3 -->	
		<div class="col_1_3">
			<h4 class="bottom_line regular"><b>Add Information</b></h4>
			...
			<form action="#" class="contact_form">
				<p>
					...
					<input class="inputText" type="number" id="discid" name="discid" />
					<label for="name"> Discipline </label>
					<input class="inputText" type="text" id="discipline" name="discipline" />
					<label for="name"> Master </label>
					<input class="inputText" type="text" id="master" name="master" />
