	...
	function sendDataToServer()
	{
		...
		if (ValidateForm() == false)    //Validate Form Fields
		    ...
		    /**************************** Basic data ***************************************/
				...
				var varOrganization = e.options[e.selectedIndex].value;				
				var x = document.getElementById("country");
				var varCountry =  x.options[x.selectedIndex].value;
			     ...
			     ipaclassArray.push(dbOrganization);			     
			     ipaclassArray.push(dbCountry);

			     alert("setIpsClassToServer"+dbKeyid+dbIpa+dbOrganization+dbCountry);
...
<body onload = loadIPInterfaceDataFromServer()>
	...
	<section class="container clearfix">
		...
		<header class="container page_info clearfix">	
			<h1 class="regular brown bottom_line"> Add IP Adresses </h1>
			<div class="clear"></div>
		</header>
		<!-- END PAGE INFO -->
		...
		<div class="col_1_4">
			<ul class="contact-address">
				...
				<li class="edit"><span><a href="IpsClassRecord.php">Search Record</a></span></li>
			</ul>
			<p>
		...
		<!-- START COL 1/3 -->	
		<div class="col_1_3">
			<h4 class="bottom_line regular"><b>Add IP Addresses</b></h4>
			...
			<form action="#" class="contact_form">
				<p>
					...
					<input class="inputText" type="number" id="keyid" name="domainid"/>
					<label for="name"> IP </label>
					<input class="inputText" type="text" id="ipa" name="ipa" placeholder="i.e. 127.0.0.1"/>
					<label for="name"> Organization <span>*</span></label>
					<select class="inputText" id="organization" name="organization" ><select>
					<label for="name"> Country <span>*</span></label>
					<select class="inputText" id="country" name="country" ><select>
