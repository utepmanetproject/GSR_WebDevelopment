...
<body onload = loadDisciplines()>
	...
	<section class="container clearfix">
		...
		<header class="container page_info clearfix">	
			<h1 class="regular brown bottom_line">Add Organizations</h1>
			<div class="clear"></div>
		</header>
		<!-- END PAGE INFO -->
		...
		<div class="col_1_4">
			<ul class="contact-address">
				...
				<li class="edit"><span><a href="OrgClassRecord.php">Search Record</a></span></li>
		...
		<div class="col_1_3">
			...
			<form action="#" class="contact_form">
				<p>
					...
					<input class="inputText" type="number" id="orgid" name="orgid"/>
