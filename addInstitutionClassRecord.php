...
<!-- 
 ...
 -->
	...
	{	
	    ...
	    var Longitude = /^-?(?:150(?:(?:\.0{1,7})?)|(?:[0-9]|[1-9][0-9])(?:(?:\.[0-9]{1,7})?))$/;
		...
		if(!ctlLongitude.value.match(Longitude) && !ctlLongitude.value == "")		
			{
			    alert("ERROR: Longitude contains invalid Input,  valid input i.e. -99; -99.0; -99.99; 0; 0.000; 99.99; 99.0; 99");
			    return false;	
	         }						         					
		return true; 
	}
	...
	function sendDataToServer()
	{
		...
		if (ValidateForm() == false)    //Validate Form Fields
		    ...
		    /**************************** Basic data ***************************************/
				...
				var varCreatedby = <?php echo "'".$_SESSION['valid_user']."'"; ?>;
...
<!-- <body onload = "loadInstitutionDataFromServer()"> -->
	...
	<section class="container clearfix">
		...
		<header class="container page_info clearfix">	
			<h1 class="regular brown bottom_line"> Add Institutional Data </h1>
			<div class="clear"></div>
		</header>
		<!-- END PAGE INFO -->
		<div class="padding15">
		...
		<div class="col_1_4">
			...
			<ul class="contact-address">
				...
				<li class="edit"><span><a href="InstitutionClassRecord.php">Search Record</a></span></li>
			</ul>
			<p>
					<a href="javascript:void(0);" class="button navy" onclick="return sendDataToServer();">Save Information</a><br>
					<a href="javascript:void(0);" class="button navy"  onclick="loadInstitutionDataFromServer();" >Clear</a>
		...
		<div class="col_1_3">
			...
			<form action="#" class="contact_form">
				<p>
					...
					<input class="inputText" type="text" id="organization" name="organization" />
