...
<head>
	...
	<title>World Class Records</title>
	<!-- links -->
	...
	{	
        ...
        if(ctlWorldid.value == "" || !ctlCode.value.match(Numbers))
	    	{
		      alert("ERROR: The worldid contains invalid input.");
	          return false;
	        }
		...
		if (!ctlWclass.value.match(LettersNumber) && !ctlWclass.value == "")
		{
			alert("ERROR: wclass contains an invalid Input");
			return false;	
		}
		...
		if(!ctlMapto.value.match(LettersNumber) && !ctlMapto.value == "")
				{
			        alert("ERROR: Mapto contains invalid Input, Only input [0-9a-zA-Z]");
			        return false;	
	         	}
...
<body >
	...
	<section class="container clearfix">
		...
		<header class="container page_info clearfix">	
			<h1 class="regular brown bottom_line">World Class</h1>
			<div class="clear"></div>
		</header>
		<!-- END PAGE INFO -->
...
<!-- 				<li class="edit"><span><a href="editWorldClassRecord.html">Edit Record</a></span></li> -->
<!-- 				<li class="delete"><span><a href="deleteWorldClassRecord.html">Delete Record</a></span></li> -->
		...
		<!-- START COL 1/3 -->	
		<div class="col_1_3">
			<h4 class="bottom_line regular"><b>World Class Information</b></h4>
			...
			<form action="#" class="contact_form">
				<p>
					...
					<input class="inputTextReadOnly" type="number" id="worldid" name="worldid" readonly/>
					<label for="name"> wclass </label>
					<input class="inputText" type="text" id="wclass" name="wclass" onkeyup="autoWorldClass()" placeholder="Type world class to search ..." />
